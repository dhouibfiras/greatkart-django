...
SECRET_KEY = "django-insecure-^=+d3^4!eh_z*fnzsh-xs&t!v8g#_ec57xde9#7hu*%bwxf3ic"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "category.context_processors.menu_links",  # ajouté
                "carts.context_processors.counter",  # ajouté
            ],
        },
    },
]
